...
const TermsPage = () => {
  ...
  return <div className='terms-page'>
    <div className='title'>QuickSwitch Service Terms</div>
    <div className='time'>Published on September 1st, 2024</div>
    <div className='terms-content'>
      QuickSwitch reserves the right to cancel or suspend any player account participation in the event, and to forfeit any rewards received for engaging in dishonest or abusive behavior. These behaviors include but are not limited to malicious clicks to gain points, bulk account building, impersonating others' accounts, using others' identity information to register accounts, providing false identity information, using devices to gain points or other malicious tools, conducting money laundering transactions or false transactions, violating any applicable rules or policies or any activity/project rules, violating local regulations or engaging in any activities aimed at abusing, interfering or disrupting the legitimate operation of the project.
    </div>
