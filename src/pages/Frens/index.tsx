...
function FrensPage() {
  ...
  return <div className='frens-page fadeIn'>
    ...
    <div className={`page-bottom maxWidth ${isH5PcRoot && 'h5Pc'}`}>
      <Button color="default" className='touch-btn' style={{ fontWeight: 'bold', height: '40px', borderRadius: '100px', flex: 1, background: 'var(--btnBg)', color: '#fff', border: 'none', fontSize: '1.4rem' }} onClick={() => handleShare()}>👆🏻 Invite Frens</Button>
      <Button color="default" className="copy touch-btn" onClick={() => copy()} style={{ borderRadius: '100px', height: '40px', padding: '0 10px' }}>
        {
